...
REAL_PARITY_PROTOCOLS="${REAL_PARITY_PROTOCOLS:-legacy_v382,modern_v400}"
REAL_PARITY_SOURCE_MODE="${REAL_PARITY_SOURCE_MODE:-manual_capture}"
...
main() {
  ...
  RUN_FULL_STACK="${RUN_FULL_STACK}" \
  RUN_DOCS_HTML=1 \
  RUN_PARITY_REPORTS="${RUN_PARITY_REPORTS}" \
  RUN_PARITY_STRICT="${RUN_PARITY_STRICT}" \
  REAL_PARITY_PROTOCOLS="${REAL_PARITY_PROTOCOLS}" \
  REAL_PARITY_SOURCE_MODE="${REAL_PARITY_SOURCE_MODE}" \
